create
or replace view public.product_details_active
with
...
from
    ...
    left join lateral (
        ...
        from
            product_packaging_types ppt
            join packaging_types pt on pt.id = ppt.packaging_type_id
        where
            ppt.product_id = p.id
...
grant
select
    on public.product_details_active to authenticated;
